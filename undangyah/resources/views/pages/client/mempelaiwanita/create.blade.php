...
<div class="col-md-8 col-lg-9 order-md-last">
    ...
    <div class="shadow-sm p-3 mb-5 bg-default rounded">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Nama panggilan mempelai wanita">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Nama Lengkap</label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Nama lengkap mempelai wanita">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Nama Ayah</label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Nama Ayah">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Nama Ibu</label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Nama Ibu">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="url" class="form-control" placeholder="Instagram" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">
            ...
            <input type="url" class="form-control" placeholder="Facebook" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <button type="submit" class="btn btn-default px-5 mt-2 py-2">Simpan</button>
    </div>
</div>
@endsection
