...
<div class="col-md-8 col-lg-9 order-md-last">
    ...
    <div class="shadow-sm p-3 mb-5 bg-default rounded">
        ...
        <div class="mb-3">
            ...
            <input type="panggilan" class="form-control" id="panggilan" placeholder="Nama lengkap mempelai pria">
        </div>
        <div class="mb-3">
            <label for="nama_ayah" class="form-label">Nama Ayah</label>
            <input type="nama_ayah" class="form-control" id="nama_ayah" placeholder="Nama Ayah">
        </div>
        <div class="mb-3">
            <label for="nama_ibu" class="form-label">Nama Ibu</label>
            <input type="nama_ibu" class="form-control" id="nama_ibu" placeholder="Nama Ibu">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="url" class="form-control" placeholder="Instagram" name="instagram" id="instagram" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">
            ...
            <input type="url" class="form-control" placeholder="Facebook" name="facebook" id="facebook" aria-label="Username" aria-describedby="basic-addon1">
        </div>
